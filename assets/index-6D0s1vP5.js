...
function CardProvider({ children }) {
  ...
  const [cardIssuer, setCardIssuer] = reactExports.useState(INITIAL_CARD.cardIssuer);
  const [expiryDate, setExpiryDate] = reactExports.useState(
    INITIAL_CARD.expiryDate
  );
  const [cardCVC, setCardCVC] = reactExports.useState(INITIAL_CARD.cardCVC);
  const [password, setPassword] = reactExports.useState(INITIAL_CARD.password);
...
function useCard() {
  const cardContext = reactExports.useContext(CardContext);
  if (!cardContext) {
    throw new Error("CardContext 외부에서 호출되고 있습니다.");
  }
  return cardContext;
}
const container$3 = "_container_1hf2k_1";
...
function InputForm(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.titleBox, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.inputBox, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7.inputContainer, children: props.children }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          style: feedbackMessage2 ? { visibility: "visible" } : { visibility: "hidden" },
          className: `${styles$7.feedbackMessage}`,
...
const selectBox = "_selectBox_1m498_1";
const selectedInputContainer = "_selectedInputContainer_1m498_9";
const selectedInput = "_selectedInput_1m498_9";
const selectedIcon = "_selectedIcon_1m498_34";
const optionBox = "_optionBox_1m498_40";
const optionList = "_optionList_1m498_54";
const hidden = "_hidden_1m498_63";
const styles$6 = {
  selectBox,
...
function Select({
  ...
  const [isOpenOptions, setIsOpenOptions] = reactExports.useState(false);
  function handleSelectClick() {
    setIsOpenOptions(true);
  }
  function selectOption(e) {
    const newSelectedValue = e.currentTarget.textContent;
    setSelectedValue(newSelectedValue);
    setIsOpenOptions(false);
    handleOptionClick(e);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.selectBox, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.selectedInputContainer, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "text",
          name,
          className: styles$6.selectedInput,
          id: "selectInput",
          placeholder,
          value: selectedValue,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: isOpenOptions ? "./SelectBox-visible.png" : "./SelectBox-hidden.png",
          alt: "Selected 드롭다운 아이콘",
          className: styles$6.selectedIcon
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "ul",
      {
        className: `${styles$6.optionBox} ${isOpenOptions ? "" : styles$6.hidden}`,
        children: optionList2.map((value) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            "li",
            {
              className: `${styles$6.optionList}`,
...
const ISSUER_LIST = /* @__PURE__ */ new Map([
  ["BC카드", "bc"],
  ["신한카드", "shinhan"],
  ["카카오뱅크", "kakao"],
  ["현대카드", "hyundai"],
...
function CardIssuerSelector({ isValid, setIsValid }) {
  const { cardIssuer, setCardIssuer } = useCard();
  function validateIssuerChange(e) {
    const targetIssuer = e.currentTarget.textContent;
...
const container$2 = "_container_hsixr_1";
const cardNumberBox = "_cardNumberBox_hsixr_15";
const logoContainer = "_logoContainer_hsixr_20";
const goldBox = "_goldBox_hsixr_25";
const logoBrand = "_logoBrand_hsixr_32";
const cardNumber = "_cardNumber_hsixr_15";
const maskingCardNumber = "_maskingCardNumber_hsixr_43";
const lotte = "_lotte_hsixr_49";
const shinhan = "_shinhan_hsixr_53";
const kakao = "_kakao_hsixr_57";
const hyundai = "_hyundai_hsixr_61";
const woori = "_woori_hsixr_65";
const hana = "_hana_hsixr_69";
const kb = "_kb_hsixr_73";
const styles$5 = {
...
function CardPreview() {
  ...
  function checkBrandCard(cardNumber2, brandNumbers) {
    return brandNumbers.some((code) => cardNumber2.startsWith(code));
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `${styles$5.container} ${issuerClassName ? styles$5[issuerClassName] : ""}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.logoContainer, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5.goldBox }),
          brand === "" ? null : /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: BRAND_IMAGE[brand],
              alt: `${brand} 로고 이미지`,
              className: styles$5.logoBrand
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${styles$5.cardNumberBox} tx-md`, children: displayCardNumbers.map((number, index) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: `${styles$5.cardNumber} ${index >= 2 ? styles$5.maskingCardNumber : ""}`,
              children: number
            },
            `card-number-${index}`
          );
        }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${styles$5.cardNumber} tx-md`, children: expiryDate.month !== "" || expiryDate.year !== "" ? `${expiryDate.month}/${expiryDate.year}` : "" })
      ]
    }
  );
}
...
function Input({
  ...
  function moveFocusNextInput(e) {
    if (ref.current) {
      ref.current.focus();
    }
    const nextInput = e.target.nextElementSibling;
    if (ref.current && nextInput && value.length === maxLength - 1 && nextInput.value.length !== maxLength) {
      nextInput.focus();
    }
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "input",
    {
      ...
      autoFocus,
      required: isRequired,
      className: `${styles$4.input} tx-md ${!isValidInput && value !== "" ? styles$4.isNotValid : ""}`,
...
const precise = {
  ...
  hasNotExpired: ({ month, year }) => {
    const today = /* @__PURE__ */ new Date();
    const currentYear = today.getFullYear();
    const currentMonth = today.getMonth() + 1;
    const expiryYear = 2e3 + Number(year);
...
function CardCVCInput({ isValid, setIsValid }) {
...
const validate = {
  checkNumberInput: (value) => {
    return precise.isNumber(value) ? { isValid: true, message: "" } : { isValid: false, message: "숫자만 입력 가능합니다." };
  },
...
function CardExpiryDateInput({
  ...
  function checkIsValidInput(name, value) {
    const { isValid: isValid2, message } = validate.checkNumberInput(value);
    if (!isValid2) {
      setFeedbackMessage(message);
      setIsValid((prev) => ({ ...prev, [name]: isValid2 }));
      return;
    }
    checkIsValidExpiry(name, value);
  }
  function checkIsValidExpiry(name, value) {
    const { month, year } = expiryDate;
    const targetMonth = name === "month" ? value : month;
    const targetYear = name === "year" ? value : year;
    const { isValid: isValid2, message } = validate.checkExpiryDate(
      targetMonth,
      targetYear
    );
    setFeedbackMessage(message);
...
function CardNumberInput({ isValid, setIsValid }) {
  ...
  function updateCardNumber(inputCardNumber, dataInputId) {
...
const cardInputForm = "_cardInputForm_y3w3r_1";
const submitButton = "_submitButton_y3w3r_8";
const styles$3 = {
  cardInputForm,
  submitButton
};
const button = "_button_1dsc2_1";
const buttonPrimary = "_buttonPrimary_1dsc2_5";
const styles$2 = {
  button,
  buttonPrimary
};
function Button({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      className: `${styles$2.button} ${styles$2.buttonPrimary} tx-xl ${className}`,
      children: title
    }
  );
}
...
function useValidateForm() {
  const [isCardNumberValid, setIsCardNumberValid] = reactExports.useState([
    true,
    true,
    true,
    true
  ]);
  const [isIssuerValid, setIsIssuerValid] = reactExports.useState(false);
  const [isExpiryDateValid, setIsExpiryDateValid] = reactExports.useState({
    month: true,
    year: true
  });
  const [isCVCValid, setIsCVCValid] = reactExports.useState(true);
  const [isPasswordValid, setIsPasswordValid] = reactExports.useState(true);
  const [isDataValid, setIsDataValid] = reactExports.useState(false);
  const ref = reactExports.useRef(null);
  reactExports.useEffect(() => {
    const isTotalNumbersValid = isCardNumberValid.every((valid) => valid);
    const isTotalExpiryDateValid = isExpiryDateValid.month && isExpiryDateValid.year;
    const isTotalDataValid = isTotalNumbersValid && isIssuerValid && isTotalExpiryDateValid && isCVCValid && isPasswordValid;
...
function CardPasswordInput({ isValid, setIsValid }) {
  ...
  function checkIsValidType(passwordInput) {
    const { isValid: isValid2, message } = validate.checkNumberInput(passwordInput);
    setFeedbackMessage(message);
    setIsValid(isValid2);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const START_INDEX = 0;
function useRender(renderItems, ref) {
  const [renderList, setRenderList] = reactExports.useState([
    renderItems[START_INDEX]
  ]);
  const [order, setOrder] = reactExports.useState(START_INDEX);
  reactExports.useEffect(() => {
    const currentItem = renderItems[order];
    if (currentItem.props.isValid && ref.current.checkValidity() && order < renderItems.length - 1) {
...
function CardInputForm() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "form",
    {
      className: styles$3.cardInputForm,
      onSubmit: submitCardInfo,
      onInput: changeValidation,
      ref,
      children: [
        renderList.map(({ Component, props }, index) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, { ...props }, index);
        }),
        isDataValid && isFormValid && /* @__PURE__ */ jsxRuntimeExports.jsx(CardSubmitButton, {})
      ]
    }
  );
}
const section$1 = "_section_y8439_1";
const container$1 = "_container_y8439_7";
const styles$1 = {
  section: section$1,
  container: container$1
};
function PaymentInputPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: styles$1.section, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardPreview, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardInputForm, {})
  ] }) });
}
const section = "_section_1nsp6_1";
const container = "_container_1nsp6_7";
const goToMainButton = "_goToMainButton_1nsp6_20";
const styles = {
  section,
  container,
  goToMainButton
